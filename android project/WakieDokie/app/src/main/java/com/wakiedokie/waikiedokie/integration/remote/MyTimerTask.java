...
import com.wakiedokie.waikiedokie.util.AlarmPIntentHelper;
...
public class MyTimerTask extends TimerTask implements Response.Listener,
    ...
    private static final String SERVER_URL = "http://128.237.176.247:8081/AndroidAppServlet/UserServlet";
